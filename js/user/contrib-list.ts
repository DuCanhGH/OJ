...
const userContributorRedirect = document.currentScript?.dataset.userContributorRedirect;
...
$(() => {
        ...
        .select2<{
            ...
            templateResult(data) {
                ...
                return $("<span>")
                    ...
                    .append(
                        $("<a>", { href: "/user/" + data.text, class: "user-redirect" })
    ...
    if (userContributorRedirect !== undefined) {
        const searchForm = document.getElementById("search-form") as HTMLFormElement;
        searchForm.action = userContributorRedirect;
    }
});
