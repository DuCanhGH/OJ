...
export interface Event<_, T> extends BaseJQueryEventObject {
    params: T;
}
...
export interface Select2RequireConfig {
    map?:
        ...
        | undefined;
    config?: { [id: string]: Record<string, any> } | undefined;
...
declare global {
    interface JQuery<TElement = HTMLElement> {
        ...
        on(
            ...
            handler?: JQueryEventHandlerBase<TElement, Event<TElement, Record<string, any>>>,
        ): this;
        on(
